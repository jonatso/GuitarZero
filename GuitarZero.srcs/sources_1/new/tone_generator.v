// inspired by https://github.com/gundy/tiny-synth/blob/develop/hdl/tone_generator.vh
// Outputs the desired tone with desired wave form

module tone_generator (
    input wire clk,
    input wire [23:0] tone_freq,
    ...
    wire [15:0] saw_dout;
    tone_generator_saw saw(
        .accumulator(accumulator),
        .dout(saw_dout)
        );

    wire [15:0] triangle_dout;
    tone_generator_triangle triangle(
        .accumulator(accumulator),
        .dout(triangle_dout)
        );

    wire [15:0] pulse_dout;
    tone_generator_pulse pulse(
        .accumulator(accumulator),
        .dout(pulse_dout),
